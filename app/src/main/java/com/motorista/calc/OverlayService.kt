...
/**
 * Desenha um overlay flutuante no estilo "semáforo" (inspirado em apps como o
 * mostrado no print de referência): colunas com R$/km, R$/hora e nota do
 * passageiro, cada uma com uma bolinha colorida (verde/amarelo/vermelho)
 * indicando se está dentro do esperado.
 */
class OverlayService : Service() {
    ...
    companion object {
        ...
        // Referências usadas só para colorir a bolinha do overlay (independente
        // dos mínimos configurados no motor de cálculo, que decidem o veredito geral).
