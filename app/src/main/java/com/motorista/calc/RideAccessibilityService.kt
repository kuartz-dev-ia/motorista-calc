...
class RideAccessibilityService : AccessibilityService() {
    ...
    private fun processarTelaDeCorrida(texto: String) {
        ...
        // Convenção observada nos prints: a primeira perna é o deslocamento até o
        // passageiro; a última é a corrida em si (embarque -> destino).
        ...
        val ride = RideInfo(
            ...
            // Se só encontramos 1 perna, tratamos como sendo a da corrida (não do pickup)
        ...
        // Sem valor extraído, não há o que calcular — evita disparar overlay "vazio".
        ...
        takeScreenshot(
            ...
            object : TakeScreenshotCallback {
                override fun onSuccess(result: ScreenshotResult) {
                    ...
                    // Próximo passo: salvar result.hardwareBuffer como bitmap em disco
                    // (fica pra quando você definir onde quer guardar o histórico).
                }
