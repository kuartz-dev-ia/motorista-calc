...
object TriggerPatterns {
    ...
    /**
     * Extrai as "pernas" da corrida (trechos com tempo+distância entre parênteses).
     * Normalmente há 2: a primeira é o deslocamento até o passageiro (pickup),
     * a última é a corrida em si (embarque -> destino).
     */
